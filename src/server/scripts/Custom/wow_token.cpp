    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else
        {
            if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Thanks for helping the Athenas-WoW project, you just received %i athenas-Coins.", (coins_1 / 10000));
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else
        {
            if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Thanks for helping the Athenas-WoW project, you just received %i athenas-Coins.", (coins_2 / 10000));
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else
        {
            if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Thanks for helping the Athenas-WoW project, you just received %i athenas-Coins.", (coins_5 / 10000));
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else
        {
            if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
            {
                ...
                ChatHandler(player->GetSession()).PSendSysMessage("Thanks for helping the Athenas-WoW project, you just received %i athenas-Coins.", (coins_10 / 10000));

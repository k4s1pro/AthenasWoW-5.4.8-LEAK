...
public:
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
        {
            ...
            ChatHandler(player->GetSession()).SendSysMessage("Thanks for helping the Athenas-WoW project, you just received 1000 honor points.");
...
public:
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
        {
            ...
            ChatHandler(player->GetSession()).SendSysMessage("Thanks for helping the Athenas-WoW project, you just received 1000 justice points.");
...
public:
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
        {
            ...
            ChatHandler(player->GetSession()).SendSysMessage("Thanks for helping the Athenas-WoW project, you just received 1000 valor points.");
...
public:
    ...
    bool OnUse(Player *player, Item *item, const SpellCastTargets &)
    {
        ...
        else if(player->HasItemCount(item->GetEntry(), 1, true)) //verify that the characters have the item
        {
            ...
            ChatHandler(player->GetSession()).SendSysMessage("Thanks for helping the Athenas-WoW project, you just received 1000 conquest points.");
